...
const About: React.FC<AboutProps> = ({ stockCount, userCount, dividendCount }) => {
  ...
  return (
    <Container>
      ...
      <div className="bg-white p-4 rounded-md shadow-md w-full grid grid-cols-2 gap-4 divide-black divide-x divide-dotted">
        {/* Left Side */}
      ...
      <div className="flex flex-col sm:flex-row items-center mt-8 gap-4 justify-between">
        <div className="bg-white p-4 rounded-md shadow-md w-full text-center">
