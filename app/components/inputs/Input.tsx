  ...
  return (
    <div className="w-full relative">
      ...
      <input
        ...
        type={type}
        className={`
        peer w-full p-4 pt-6 font-light bg-white dark:bg-black dark:text-white border-2 rounded-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed
