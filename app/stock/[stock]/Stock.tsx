  ...
  return (
    <Container>
      <div className="max-w-screen-lg mx-auto">
        ...
        <div className="dark:bg-gray-800 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 sm:gap-2 md:gap-2 lg:gap-8 shadow-custom rounded-md">
